...
>
> **Note**: Windows is experimental supported although additional processing is required. See also [Build for windows].
>
...
[Build for windows]: Documentation/BuildForWindows.md
